...
lmm_max_token_length = 1600 #was 1600 
num_region_caption = 16 #was 16
use_short_cap=False
...
# --------------------------- student behavior emotion vg dataset---------------------------
...
param_scheduler = [
    ...
    dict(
        ...
        by_epoch=False,
        milestones=[20000, 23000], #was 120000 140000
        gamma=0.1)
]

default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=3000, max_keep_ckpts=30),
