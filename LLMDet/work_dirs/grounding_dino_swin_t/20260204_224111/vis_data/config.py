...
caption_dataset = dict(
    ...
    pipeline=[
        ...
        dict(
            ...
            tokenizer_name='../huggingface/bert-base-uncased/',
            tokenizer_name2=
...
load_from = '/home/jovyan/Computer_vision/LLMDet/work_dirs/grounding_dino_swin_t/iter_15000.pth'
log_level = 'INFO'
...
model = dict(
    ...
    language_model=dict(
        ...
        max_tokens=256,
        name='../huggingface/bert-base-uncased/',
        pad_to_max=False,
        special_tokens_list=[
            '[CLS]',
            '[SEP]',
    ...
    lmm='../huggingface/my_llava-onevision-qwen2-0.5b-ov-2/',
    lmm_connector=
    '../huggingface/my_llava-onevision-qwen2-0.5b-ov-2/mm_projector2.bin',
...
test_evaluator = dict(
    ...
    metrics=[
        ...
        dict(
            ann_file=
            '../grounding_data/frames1/student_behavior_emotion_vg7_val.jsonl',
            iou_thrs=0.5,
            metric='bbox',
            topk=(
                1,
...
train_cfg = dict(max_iters=18000, type='IterBasedTrainLoop', val_interval=1500)
...
train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        tokenizer_name='../huggingface/bert-base-uncased/',
        tokenizer_name2='../huggingface/my_llava-onevision-qwen2-0.5b-ov-2/',
        type='RandomSamplingNegPos2'),
    dict(
        meta_keys=(
            'img_id',
