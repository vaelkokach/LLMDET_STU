...
load_from = '/home/jovyan/Computer_vision/LLMDet/work_dirs/grounding_dino_swin_t/iter_16000.pth'
log_level = 'INFO'
...
train_cfg = dict(max_iters=25000, type='IterBasedTrainLoop', val_interval=3000)
