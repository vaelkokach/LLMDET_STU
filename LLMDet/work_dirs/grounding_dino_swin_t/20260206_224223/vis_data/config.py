...
load_from = '/home/jovyan/Computer_vision/LLMDet/work_dirs/grounding_dino_swin_t/iter_25000.pth'
log_level = 'INFO'
...
train_cfg = dict(max_iters=35000, type='IterBasedTrainLoop', val_interval=3000)
